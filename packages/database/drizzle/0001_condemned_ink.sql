...
ALTER TABLE "businesses" ADD COLUMN "country" text DEFAULT 'NG' NOT NULL;--> statement-breakpoint
ALTER TABLE "businesses" ADD COLUMN "state" text NOT NULL;--> statement-breakpoint
ALTER TABLE "businesses" ADD COLUMN "lga" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "users" ADD COLUMN "kyc_status" "kyc_status" DEFAULT 'UNVERIFIED' NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "nin" text;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "dob" text;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "nin_data" jsonb DEFAULT '{}'::jsonb NOT NULL;--> statement-breakpoint
...
CREATE INDEX "kyc_verifications_nin_idx" ON "kyc_verifications" USING btree ("nin");--> statement-breakpoint
CREATE INDEX "kyc_verifications_status_idx" ON "kyc_verifications" USING btree ("status");--> statement-breakpoint
CREATE INDEX "businesses_country_state_idx" ON "businesses" USING btree ("country","state");--> statement-breakpoint
...
ALTER TABLE "public"."business_members" ALTER COLUMN "role" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "public"."users" ALTER COLUMN "role" SET DATA TYPE text;--> statement-breakpoint
DROP TYPE "public"."user_role";--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('SUPER_ADMIN', 'STAFF', 'SUPPORT', 'BUSINESS_OWNER', 'BUSINESS_ADMIN', 'DEVELOPER');--> statement-breakpoint
ALTER TABLE "public"."business_members" ALTER COLUMN "role" SET DATA TYPE "public"."user_role" USING "role"::"public"."user_role";--> statement-breakpoint
